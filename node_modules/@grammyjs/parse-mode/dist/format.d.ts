...
import type { EntityTag } from "./entity-tag.js";
/**
 ...
 */
export declare class FormattedString implements CaptionWithEntities, TextWithEntities, TextWithTextEntities, TitleWithTitleEntities, Stringable {
    rawText: string;
    /**
     ...
     */
    static emoji(text: Stringable, customEmojiId: string): FormattedString;
    /**
     ...
     */
    static time(text: Stringable, unixTime: number, dateTimeFormat?: MessageEntity.DateTimeMessageEntity["date_time_format"]): FormattedString;
    /**
     ...
     */
    emoji(text: Stringable, customEmojiId: string): FormattedString;
    /**
     ...
     */
    time(text: Stringable, unixTime: number, dateTimeFormat?: MessageEntity.DateTimeMessageEntity["date_time_format"]): FormattedString;
    /**
 ...
 */
export declare function fmt(rawStringParts: TemplateStringsArray | string[], ...entityTagsOrFormattedTextObjects: (Stringable | TextWithEntities | CaptionWithEntities | EntityTag | (() => EntityTag))[]): FormattedString;
/**
