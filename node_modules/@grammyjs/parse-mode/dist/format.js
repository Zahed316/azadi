...
const entity_tag_js_1 = require("./entity-tag.js");
...
class FormattedString {
     ...
     */
    static b(text) {
        return fmt `${entity_tag_js_1.b}${text}${entity_tag_js_1.b}`;
    }
    /**
     * Creates a bold formatted string
     * @param text The text content to format as bold
     ...
     */
    static bold(text) {
        return fmt `${entity_tag_js_1.bold}${text}${entity_tag_js_1.bold}`;
    }
    /**
     ...
     */
    static i(text) {
        return fmt `${entity_tag_js_1.i}${text}${entity_tag_js_1.i}`;
    }
    /**
     * Creates an italic formatted string
     * @param text The text content to format as italic
     ...
     */
    static italic(text) {
        return fmt `${entity_tag_js_1.italic}${text}${entity_tag_js_1.italic}`;
    }
    /**
     ...
     */
    static s(text) {
        return fmt `${entity_tag_js_1.s}${text}${entity_tag_js_1.s}`;
    }
    /**
     * Creates a strikethrough formatted string
     * @param text The text content to format with strikethrough
    ...
    static strikethrough(text) {
        return fmt `${entity_tag_js_1.strikethrough}${text}${entity_tag_js_1.strikethrough}`;
    }
    /**
     ...
     */
    static u(text) {
        return fmt `${entity_tag_js_1.u}${text}${entity_tag_js_1.u}`;
    }
    /**
     * Creates an underline formatted string
     * @param text The text content to format with underline
    ...
    static underline(text) {
        return fmt `${entity_tag_js_1.underline}${text}${entity_tag_js_1.underline}`;
    }
    /**
     ...
     */
    static a(text, url) {
        return fmt `${(0, entity_tag_js_1.a)(url)}${text}${entity_tag_js_1.a}`;
    }
    /**
     * Creates a link formatted string
     * @param text The text content to display as a link
    ...
    static link(text, url) {
        return fmt `${(0, entity_tag_js_1.link)(url)}${text}${entity_tag_js_1.link}`;
    }
    /**
     ...
     */
    static code(text) {
        return fmt `${entity_tag_js_1.code}${text}${entity_tag_js_1.code}`;
    }
    /**
    ...
    static pre(text, language) {
        return fmt `${(0, entity_tag_js_1.pre)(language)}${text}${entity_tag_js_1.pre}`;
    }
    /**
     ...
     */
    static spoiler(text) {
        return fmt `${entity_tag_js_1.spoiler}${text}${entity_tag_js_1.spoiler}`;
    }
    /**
    ...
    static blockquote(text) {
        return fmt `${entity_tag_js_1.blockquote}${text}${entity_tag_js_1.blockquote}`;
    }
    /**
    ...
    static expandableBlockquote(text) {
        return fmt `${entity_tag_js_1.expandableBlockquote}${text}${entity_tag_js_1.expandableBlockquote}`;
    }
    /**
     ...
     */
    static emoji(text, customEmojiId) {
        return fmt `${(0, entity_tag_js_1.emoji)(customEmojiId)}${text}${entity_tag_js_1.emoji}`;
    }
    /**
     ...
     */
    static time(text, unixTime, dateTimeFormat) {
        return fmt `${(0, entity_tag_js_1.time)(unixTime, dateTimeFormat)}${text}${entity_tag_js_1.time}`;
    }
    /**
     ...
     */
    time(text, unixTime, dateTimeFormat) {
...
function fmt(rawStringParts, ...entityTagsOrFormattedTextObjects) {
    ...
    return new FormattedString(rawText, (0, util_js_1.consolidateEntities)(rawEntities));
}
// Utility functions
/**
...
function mentionUser(stringLike, userId) {
    return fmt `${(0, entity_tag_js_1.a)(`tg://user?id=${userId}`)}${stringLike}${entity_tag_js_1.a}`;
}
/**
...
function customEmoji(placeholder, emoji) {
    return fmt `${(0, entity_tag_js_1.a)(`tg://emoji?id=${emoji}`)}${placeholder}${entity_tag_js_1.a}`;
}
/**
...
function linkMessage(stringLike, chatId, messageId) {
    if (chatId > 0) {
        ...
        return fmt `${(0, entity_tag_js_1.a)(`https://t.me/c/${(chatId + 1000000000000) * -1}/${messageId}`)}${stringLike}${entity_tag_js_1.a}`;
    }
}
