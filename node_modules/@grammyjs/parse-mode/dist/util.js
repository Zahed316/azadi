...
exports.copyMessageEntity = copyMessageEntity;
/**
...
function isEntitySimilar(entity1, entity2) {
    ...
    if (entity1.type === "date_time" && entity2.type === "date_time") {
        return entity1.unix_time === entity2.unix_time &&
            ((_a = entity1.date_time_format) !== null && _a !== void 0 ? _a : "") === ((_b = entity2.date_time_format) !== null && _b !== void 0 ? _b : "");
    }
...
function consolidateEntities(entities) {
    ...
    for (const sortedEntity of sortedEntities) {
        ...
        if (sortedEntity.type === "text_link") {
            ...
            key += `|${sortedEntity.unix_time}|${(_a = sortedEntity.date_time_format) !== null && _a !== void 0 ? _a : ""}`;
        }
...
function compareEntities(a, b) {
    ...
    if (a.type === "date_time" && b.type === "date_time") {
        ...
        return ((_c = a.date_time_format) !== null && _c !== void 0 ? _c : "").localeCompare((_d = b.date_time_format) !== null && _d !== void 0 ? _d : "");
    }
 ...
 */
function copyMessageEntity(entity) {
